...
--
ALTER TABLE `tasks`
  MODIFY `task_id` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `tasks`
  ADD CONSTRAINT `tasks_user_id` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`);
COMMIT;
